# This Makefile is for the Games::RollDice extension to perl.
#
...
#     ABSTRACT => q[Generate random die rolls for RPGs (et al)]
#     AUTHOR => q[Buddy Burden  C<< barefootcoder@gmail.com >>]
#     BUILD_REQUIRES => { Test::More=>q[0.88], ExtUtils::MakeMaker=>q[6.56] }
#     DISTNAME => q[Games-RollDice]
#     LICENSE => q[perl]
#     MIN_PERL_VERSION => q[5.008]
#     NAME => q[Games::RollDice]
#     NO_META => q[1]
#     PREREQ_PM => { Test::More=>q[0.88], ExtUtils::MakeMaker=>q[6.56] }
#     VERSION => q[0.50_01]
#     VERSION_FROM => q[lib/Games/RollDice.pm]
...
MAKE = make
FULLEXT = Games/RollDice
BASEEXT = RollDice
PARENT_NAME = Games
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Games/RollDice.pm
OBJECT =
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP =
...
H_FILES  =
MAN1PODS =
MAN3PODS = lib/Games/RollDice.pm
...
TO_INST_PM = lib/Games/RollDice.pm

PM_TO_BLIB = lib/Games/RollDice.pm \
    blib/lib/Games/RollDice.pm
...
DISTNAME = Games-RollDice
DISTVNAME = Games-RollDice-0.50_01
...
manifypods : pure_all  \
    lib/Games/RollDice.pm
    $(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
      lib/Games/RollDice.pm $(INST_MAN3DIR)/Games::RollDice.$(MAN3EXT)
...
ppd :
    $(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.50_01">' > $(DISTNAME).ppd
    $(NOECHO) $(ECHO) '    <ABSTRACT>Generate random die rolls for RPGs (et al)</ABSTRACT>' >> $(DISTNAME).ppd
    $(NOECHO) $(ECHO) '    <AUTHOR>Buddy Burden  C&lt;&lt; barefootcoder@gmail.com &gt;&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
    $(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
      lib/Games/RollDice.pm blib/lib/Games/RollDice.pm
